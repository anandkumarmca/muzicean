...
class ScheduleCancel extends React.Component {
  ...
  markFA() {
    if (this.form.remark.state.value != null) {
      POST(
        SERVER +
          'users/scheduleFAPL.json?id=' +
          this.props.route.params.id +
          '&dateid=' +
          this.props.route.params.dateid,
        {
          status: 1,
          _centre_id: this.props.route.params._centre_id,
          cancelreason: this.form.remark.state.value,
          _confrim: this.state.checkflag,
        },
      )
        .then(response => {
          if (response.error) {
            ...
            Alert.alert('FA Alert', 'Faculty has been marked absent!!');
            ...
            if (this.props.route.params.navigate == 'batchlist') {
              ...
              //  this.props.navigation.navigate('OverdueBatch', { data: this.props.route.params.index, date: this.props.route.params.date, total: this.props.route.params.total })
            } else if (this.props.route.params.navigate == 'overdueedit') {
              this.props.navigation.reset({
                index: 0,
                routes: [{name: 'OverdueList'}],
              });
              //this.props.navigation.navigate('OverdueBatchEdit', {batch: this.props.route.params.data});
            } else {
      ...
      Alert.alert('FA Alert', 'Please enter remark field!!!');
    }
  }
            ...
            <ScrollView
              ...
              <View
                ...
                <Text style={{fontSize: 18, color: PROPERTY.selectedColor}}>
                  Date :{this.props.route.params.batchdate}
                </Text>
                <Text style={{fontSize: 18, color: PROPERTY.selectedColor}}>
                    ...
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <View style={{flex: 86}}>
                        <Text
                          ...
                          Confirm to Mark FA for All in this batch{' '}
                        </Text>
                      </View>
                    </View>
                  </View>
...
export default connect(mapstate)(ScheduleCancel);
